        ...
        (_.prototype._updateImpl = function () {
          ...
          if (!(this._points.length < 2)) {
            ...
            var D = Math.min(p.x, u.x),
              k = Math.max(p.x, u.x),
              N = M.fillBackground.value(),
              B = M.transparency.value(),
                ...
                if (T > 0 && N) {
                  var E = this._levels[T - 1],
                    z =
                      ...
                      {});
                  (z.points = [i, u]),
                    (z.color = this._levels[T].color),
                    (z.linewidth = 0),
                    (z.backcolor = this._levels[T].color),
                    (z.fillBackground = !0),
                    (z.transparency = B),
                    (z.extendLeft = A),
                    (z.extendRight = j);
                  var V = new n(void 0, void 0, !0);
                  V.setData(z), I.append(V);
                }
            var H = D,
              W = k;
            H === W && (A && (H -= 1), j && (W += 1));
        ...
        (S.prototype.drawTargetLabel = function (e) {
          ...
          if ((e.fillText(o, T + d + p + 2 * u + D, M), this._data.status)) {
            ...
            var j = this._targetFontSize1 + 4,
              ...
              z = Math.round((this._targetWidth - E) / 2),
              V = v(e, E);
            (e.fillStyle = N),
              'up' === this._data.direction
                ...
                : (y(
                  ...
                  e.fill(),
                  (e.fillStyle = B),
                  e.fillText(k, R.x + z + V, R.y + this._targetHeight + 5),
                  e.drawImage(
                    A,
                    R.x + z - A.width - 4,
      ...
      inherit(_, n),
        ...
        (_.prototype._updateImpl = function () {
          ...
          if (t && !t.isEmpty() && !i.isEmpty()) {
            ...
            for (var j = [], E = 0; E < this._points.length; E++) {
    ...
    LMGK: function (e, t, i) {
      ...
      function p(e, t) {
        a.call(this, e, t),
          ...
          (this._orderRenderer = new u(this._orderRendererCache, e._adapter)),
      ...
      inherit(u, d),
        ...
        (u.prototype._bodyWidth = function (e) {
          if (0 === this._adapter.getText().length) return 0;
          e.save(), (e.font = this._adapter.getBodyFont());
          var t = e.measureText(this._adapter.getText()).width;
          return e.restore(), Math.round(20 + t);
        }),
        (u.prototype._getQuantity = function () {
          return s(this._adapter.getQuantity(), ' ');
        }),
        (u.prototype._quantityWidth = function (e) {
          if (0 === this._getQuantity().length) return 0;
          e.save(), (e.font = this._adapter.getQuantityFont());
          var t = e.measureText(this._getQuantity()).width;
          return e.restore(), Math.round(Math.max(this._height(), 10 + t));
        }),
        (u.prototype._cancelButtonWidth = function () {
          return this._adapter.isOnCancelCallbackPresent() ? this._height() : 0;
        }),
        (u.prototype._drawLines = function (e, t, i, r, n) {
          e.save(),
            (e.strokeStyle = this._adapter.getLineColor()),
            (e.lineStyle = this._adapter.getLineStyle()),
            (e.lineWidth = this._adapter.getLineWidth()),
        ...
        (u.prototype._drawMovePoints = function (e, t, i) {
          e.save(),
            (e.strokeStyle = this._adapter.getBodyBorderColor()),
          ...
          for (
            ...
            var s = i + 5 + 2 * o;
            CanvasEx.drawLine(e, r, s, n, s);
          }
          e.restore();
        }),
        (u.prototype._drawBody = function (e, t, i) {
          (e.strokeStyle = this._adapter.getBodyBorderColor()),
            (e.fillStyle = this._adapter.getBodyBackgroundColor());
          var r = this._bodyWidth(e),
            n = this._height();
        ...
        (u.prototype._drawBodyText = function (e, t, i) {
          (e.textAlign = 'center'),
            (e.textBaseline = 'middle'),
            (e.font = this._adapter.getBodyFont()),
            (e.fillStyle = this._adapter.getBodyTextColor());
        ...
        (u.prototype._drawQuantity = function (e, t, i, r) {
          e.save(),
            (e.strokeStyle = this._adapter.getQuantityBorderColor()),
            (e.fillStyle = this._adapter.getQuantityBackgroundColor());
        ...
        (u.prototype._drawQuantityText = function (e, t, i) {
          e.save(),
            (e.textAlign = 'center'),
            (e.textBaseline = 'middle'),
            (e.font = this._adapter.getQuantityFont()),
        ...
        (u.prototype._drawCancelButton = function (e, t, i, r) {
        ...
        (u.prototype.hitTest = function (e) {
          ...
          if (
            ...
            var t = this._adapter.hasMoveCallback() ? o.MOVEPOINT : o.REGULAR;
        ...
        (p.prototype._updateImpl = function (e) {
          if (
            ...
            var t = this._points[0].y,
              i = e - l.RADIUS - 1,
              n = this._adapter.hasMoveCallback() ? o.MOVEPOINT : o.REGULAR,
              s = [new r(i, t)];
            this._selectionData = {
              points: s,
      ...
      inherit(g, n),
        ...
        (g.prototype._updateImpl = function () {
          if (
            ...
            var B = this._textRenderer.measure(),
              A = o(B, i, a, N, this._source.priceScale().height());
            ...
            if (this._secondPoint && this._points.length > 0) {
              ...
              if (
                ...
                var I = this._source.properties().statsPosition.value(),
                  ...
                  N = D ? p.textColorDark : p.textColorLight,
                  B = {
                    points: [O],
                    text: this._label,
                    color: N,
                ...
                (B.offsetX = A),
                  ...
                  ((this._points[1].y < this._points[0].y &&
                    ...
                    (this._points[1].y > this._points[0].y &&
                      this._points[1].x > this._points[0].x)) &&
                    (B.vertAlign = 'bottom'),
                  S.append(new g(new a(B, this._rendererCache)));
              }
              this._middlePoint &&
                S.append(
                  new d({
              ...
              var E = Math.round((180 * j.angle) / Math.PI) + 'º';
        ...
        (c.prototype._updateImpl = function () {
          if (
            ...
            for (p = 0; p < this._hlevels.length; p++) {
              if (p > 0 && M) {
                ...
                ((j = {}).points = [e, t]),
                  ...
                  (j.extendLeft = !1),
                  (j.extendRight = !1),
                  (z = new o(void 0, void 0, !0)).setData(j),
                  R.append(z);
              }
              var N = {
                points: [
            ...
            for (p = 0; p < this._vlevels.length; p++) {
              ...
              if (
                ((z = new s()).setData(N), R.append(z), C.showTopLabels.value())
              ) {
                var V = {
                  points: [e],
            ...
            if (i) {
              ...
              if (
                ...
                var M = function (e, t, i, r, n, a, o) {
                  ...
                  k = Math.abs(O - I),
                  N = Math.round((1e4 * k) / I) / 100,
                  B = Math.abs(D - I),
                  A = Math.round((1e4 * B) / I) / 100,
                ...
                if (
                  ...
                  var W = this._isClosed
                    ...
                    : this.i18nCache.open;
                  (z += V ? this.i18nCache.pnl.format(W, V) + ', ' : ''),
                    (z += this.i18nCache.qty.format(c.qty.value()) + '\n'),
                    (z += this.i18nCache.ratio.format(H) + ' ');
                }
                ...
                (E = new r((g + x) / 2, this._profitLevel)),
                  (z = ''),
                  (U = this._source.ownerSource().formatter().format(B)),
                  (Z = this._percentageFormatter.format(A));
                (z = c.compact.value()
                  ? U + ' (' + Z + ') ' + c.amountTarget.value()
                  : this.i18nCache.target.format(
                      v(this._source.ownerSource().formatter().format(B)),
                      v(this._percentageFormatter.format(A)),
                      this._pipFormatter ? v(this._pipFormatter.format(B)) : '',
